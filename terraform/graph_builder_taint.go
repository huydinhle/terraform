...
// TaintGraphBuilder implements GraphBuilder and is responsible for building
...
// See GraphBuilder
func (b *TaintGraphBuilder) Build(path []string) (*Graph, error) {
	return (&BasicGraphBuilder{
		Steps:    b.Steps(),
		Validate: b.Validate,
		Name:     "TaintGraphBuilder",
	}).Build(path)
}

// See GraphBuilder
func (b *TaintGraphBuilder) Steps() []GraphTransformer {
	...
	concreteResource := func(a *NodeAbstractResource) dag.Vertex {
		return &NodeTaintableResource{
			NodeAbstractResource: a,
		}
	}

	// Note: I don't know if we should taint data resource
